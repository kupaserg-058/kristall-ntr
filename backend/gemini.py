...
Федеральные приоритетные направления НТР
(Указ Президента РФ №145 от 28.02.2024):
1. Цифровые технологии и искусственный интеллект
2. Технологии для жизни и здоровья
3. Технологии для безопасности
4. Технологии для освоения пространства и Мирового океана
5. Атомные и ядерные технологии
6. Новые материалы и химические технологии
7. Зелёные и энергетические технологии

Проанализируй документ. Найди ВСЕ упомянутые направления
научно-технологического развития. Для каждого определи наиболее
близкое федеральное направление из списка выше.
